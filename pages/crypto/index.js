                    ...
                    <div className={"cryptoAdBlock_first"}>
                        <div className={"cryptoAdBlock__container"}>
                            ...
                            <div className={"cryptoAdBlock_first__buttons"}>
                                <button>
                                    <svg version="1.1" id="Capa_1" width={"10px"} height={"10px"} xmlns="http://www.w3.org/2000/svg"x="0px" y="0px"
		...
		S12.675,5.92,12.675,5.92z"/>
                                ...
                                <button>
                                    <svg width="10px" height="10px" viewBox="0 0 8 8">
                                        <path style={{fill: "#fff"}} d="M2 0v5h-2l3.03 3 2.97-3h-2v-5h-2z" transform="translate(1)" />
                                    </svg>
                                    Продать</button>
                            </div>
                        </div>
